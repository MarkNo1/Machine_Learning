...
class classificator:
    ...
    def train_test(self):
        self.X_train, self.X_test, self.Y_train, self.Y_test = train_test_split(
            self.X, self.Y, test_size=0.50, random_state=0)  # Divide in 2 porzioni da 144,3 mischiate

    def gaussianNB(self):
        # Fit gaussian naive bayes according X,Y.
    ...
    def plot(self):
        ...
        plt.grid()
        plt.title("Prediction with the " + self.name)
